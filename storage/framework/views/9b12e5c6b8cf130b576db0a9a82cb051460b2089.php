...
<table id="myTable">
 <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
  <tr>
    <td><img src="diet.png" style="width: 16%;border: 3px solid  #FF4B4B;border-radius: 25px;"> &nbsp; &nbsp; &nbsp;<?php echo e($food->foodName); ?> &nbsp; &nbsp; &nbsp; Calorie: <?php echo e($food->calorie); ?>  &nbsp;gram &nbsp; &nbsp; &nbsp;</td>
      <td><a href="<?php echo e(route('dFood.info',['id'=>$food->id])); ?>" class="btn btn-success" role="button">view</a></td>
