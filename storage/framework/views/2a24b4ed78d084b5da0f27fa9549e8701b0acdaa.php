...
<div class="vertical-menu1">
    <a href="" class="active">Food Name: <?php echo e($foodDetails->foodName); ?></a>
</div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-25">
      <label for="age" style="font-size:20px;color:#FF4B4B">Calorie: <?php echo e($foodDetails->calorie); ?> kcal</label>
    </div>
     <div class="col-25">
      <label for="age" style="font-size:20px;color:#FF4B4B">Fat: <?php echo e($foodDetails->fat); ?> g</label>
    </div>
  </div>
    <div class="row">
     <div class="col-25">
      <label for="age" style="font-size:20px;color:#FF4B4B">Protein: <?php echo e($foodDetails->protein); ?> g</label>
    </div>
     <div class="col-25">
      <label for="age" style="font-size:20px;color:#FF4B4B">Carbohydrate: <?php echo e($foodDetails->carbohydrate); ?> g</label>
    </div>
  </div>
    <div class="row">
     <div class="col-25">
      <label for="age" style="font-size:30px;color:#FF4B4B;margin-left: 270px">How to burn <?php echo e($foodDetails->calorie); ?> kcal?</label>
    </div>
     <div class="col-25">
      <img src="../burn.png" style="width: 50%;margin-left: 190px">
    </div>
    <div class="col-25">
      <label for="age" style="font-size:30px;color:#FF4B4B;margin-left:220px"><?php echo e($walking); ?> min&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($running); ?> min&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($cycling); ?> min</label>
    </div>
