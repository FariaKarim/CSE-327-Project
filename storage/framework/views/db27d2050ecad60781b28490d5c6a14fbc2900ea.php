...
<table id="myTable">
 <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
  <tr>
    <td><img src="doctor.png" style="width: 16%;border: 3px solid  #FF4B4B;border-radius: 25px;"> &nbsp; &nbsp; &nbsp;<?php echo e($doctor->doctorName); ?> &nbsp; &nbsp; &nbsp; Email: <?php echo e($doctor->doctorEmail); ?><p style="margin-top: -30px;margin-left: 128px;">Chamber Address:<?php echo e($doctor->chamAdd); ?>&nbsp; &nbsp; &nbsp; Hospital Address:<?php echo e($doctor->hospAdd); ?></p> <p style="margin-left:128px;">Contact No.:<?php echo e($doctor->contact); ?>&nbsp; &nbsp; &nbsp; Specialized:<?php echo e($doctor->specialized); ?></p><p style="margin-left: 128px;">Qualification:<?php echo e($doctor->qualification); ?></p><p style="margin-left: 128px;">Gender:<?php echo e($doctor->gender); ?>&nbsp; &nbsp; &nbsp; Age:<?php echo e($doctor->age); ?></p></td>
    <td></td>
