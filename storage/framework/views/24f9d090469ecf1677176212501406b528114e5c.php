...
<!-- sidebar end -->
<!-- table start -->
<div style="margin-top: 120px;margin-left:540px;color:#FF4B4B;font-size: 50px; "> <p>Ambulance List</p></div>
<br>
<br>


<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
<a href="<?php echo e(route('formAmbulance')); ?>"><button type="button" class="btn btn-danger" style="margin-left:150px;border-color: red;height: 40px;width: 200px;font-size: 20px">ADD</button></a>
<br>
<br>
<table id="myTable" style="margin-left:150px">
  <tr class="header">
    
    <th style="width:20%;">Ambulance Company Name</th>
    <th style="width:20%;">Contact No.</th>
    <th style="width:20%;">Website Link</th>
    
  </tr>
   <?php $__currentLoopData = $ambulances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ambulance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
  <tr>
    
    <td><?php echo e($ambulance->ambulanceName); ?></td>
    <td><?php echo e($ambulance->contact); ?></td>
    <td><?php echo e($ambulance->weblink); ?></td>
