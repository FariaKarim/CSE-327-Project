...
<div class="vertical-menu1">
    <a href="Calculation.html" class="active">ADD AMBULANCE</a>
</div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-25">
      <label for="ambulanceName" style="font-size:20px;color:#FF4B4B">Ambulance Company Name</label>
    </div>
    <div class="col-25">
      <input type="text" id="ambulanceName" name="ambulanceName" placeholder="Ambulance Company Name..">
    </div>
  </div>
   ...
   <div class="row">
    ...
    <div class="col-25">
      <label for="weblink" style="font-size:20px;color:#FF4B4B">Website Link</label>
    </div>
    <div class="col-25">
      <input type="text" id="weblink" name="weblink" placeholder="Website Link..">
    </div>
  </div>
