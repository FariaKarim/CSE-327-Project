...
<table id="myTable">
 <?php $__currentLoopData = $ambulances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ambulance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
  <tr>
    <td><img src="../ambulance.png" style="width: 16%;border: 3px solid  #FF4B4B;border-radius: 25px;"> &nbsp; &nbsp; &nbsp;<?php echo e($ambulance->ambulanceName); ?> &nbsp; &nbsp; &nbsp; Contact: <?php echo e($ambulance->contact); ?> &nbsp;gram &nbsp; &nbsp; &nbsp;</td>
      <td>Website link: <?php echo e($ambulance->weblink); ?></td>
