...
<!-- sidebar end -->
<!-- table start -->
<div style="margin-top: 120px;margin-left:560px;color:#FF4B4B;font-size: 50px; "> <p>Medicine List</p></div>
<br>
<br>


<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
<a href="<?php echo e(route('formMedicine')); ?>"><button type="button" class="btn btn-danger" style="margin-left:150px;border-color: red;height: 40px;width: 200px;font-size: 20px">ADD</button></a>
<br>
<br>
<table id="myTable" style="margin-left:150px;">
  <tr class="header">
    ...
    <th style="width:20%;">Side Effect</th>
  ...
  <tr>
    ...
    <td><?php echo e($medicine->medicineName); ?></td>
    <td><?php echo e($medicine->disease); ?></td>
    <td><?php echo e($medicine->sideEffect); ?></td>
    <td><?php echo e($medicine->group); ?></td>
    <td><?php echo e($medicine->element); ?></td>
    <td><?php echo e($medicine->barcode); ?></td>
