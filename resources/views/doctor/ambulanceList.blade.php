...
<table id="myTable">
 @foreach($ambulances as $key => $ambulance) 
  <tr>
    <td><img src="../ambulance.png" style="width: 16%;border: 3px solid  #FF4B4B;border-radius: 25px;"> &nbsp; &nbsp; &nbsp;{{$ambulance->ambulanceName}} &nbsp; &nbsp; &nbsp; Contact: {{$ambulance->contact}} &nbsp;gram &nbsp; &nbsp; &nbsp;</td>
      <td>Website link: {{$ambulance->weblink}}</td>
