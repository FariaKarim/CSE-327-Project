   ...
   <script type="text/javascript">
    function calcVolume()
    {
      ...
      if(opW=="kg"&&opH=="m"&&opG=="male")
      {
          ...
          document.getElementById("volume").value=(0.006012*height*height*height)+(14.6*weight)+604;
      }
      else if(opW=="kg"&&opH=="m"&&opG=="female")
      {
          weight=weight*2.20462
          height=height*39.3701
          document.getElementById("volume").value=(0.005835*height*height*height)+(15*weight)+183;
      }
      ...
      {
        document.getElementById("volume").value="Error in selecting units";
      }
...
<div class="vertical-menu3">
    <a href="" class="active">Blood Volume</a>
</div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <select id="opH" name="Height">
        ...
        <option value="inch">Imperial(in)</option> 
    </select>
  ...
  <br>
  <div class="row">
     <button type="button" class="btn btn-danger btn-lg" style="background-color: #FF4B4B; margin-left: 650px" onclick="calcVolume();">Calculate</button>
  </div>
  <label for="Gender" style="font-size:20px;color:#FF4B4B">Blood volume:</label><input type="text" id="volume">&nbsp<label for="Gender" style="font-size:20px;color:#FF4B4B">mL</label>
  </form>
</div>
 </div>
</div>
