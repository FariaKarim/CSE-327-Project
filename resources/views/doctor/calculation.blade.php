...
<div class="container">
  ...
  <!--box design -->
<a href="{{route('dBmi')}}"><div class="box1"><img src="bmi.png" style="height:125px;width:125px;margin-top:-30px;margin-left:40px"><p style="padding-top:20px;color:white;text-align: center;font-size: 30px;">Body Mass Index</p></div></a>
<!--end of box design -->
 <a href="{{route('dPressure')}}"><div class="box2"><img src="pressure.png" style="height:125px;width:125px;margin-top:22px;margin-left:85px"><p style="padding-top:15px;color:white;text-align: center;font-size: 30px;">Blood Pressure</p></div></a>

<a href="{{route('dVolume')}}"><div class="box3"><img src="volume.png" style="height:100px;width:100px;margin-top:-30px;margin-left:15px"><p style="padding-top:15px;color:white;text-align: center;font-size: 23px;">Blood Volume</p></div></a>

  <a href="{{route('dWater')}}"><div class="box4"><img src="water.png" style="height:100px;width:120px;margin-top:-30px;margin-left:-10px"><p style="padding-top:15px;color:white;text-align: center;font-size: 23px">Body<br>Water</p></div></a>

<a href="{{route('dFat')}}"><div class="box5"><img src="fat.png" style="height:100px;width:100px;margin-top:-30px;margin-left:10px"><p style="padding-top:15px;color:white;text-align: center;font-size: 23px">Body<br>Fat</p></div></a>
