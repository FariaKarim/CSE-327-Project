...
<table id="myTable">
 @foreach($doctors as $key => $doctor) 
  <tr>
    <td><img src="doctor.png" style="width: 16%;border: 3px solid  #FF4B4B;border-radius: 25px;"> &nbsp; &nbsp; &nbsp;{{$doctor->doctorName}} &nbsp; &nbsp; &nbsp; Email: {{$doctor->doctorEmail}}<p style="margin-top: -30px;margin-left: 128px;">Chamber Address:{{$doctor->chamAdd}}&nbsp; &nbsp; &nbsp; Hospital Address:{{$doctor->hospAdd}}</p> <p style="margin-left:128px;">Contact No.:{{$doctor->contact}}&nbsp; &nbsp; &nbsp; Specialized:{{$doctor->specialized}}</p><p style="margin-left: 128px;">Qualification:{{$doctor->qualification}}</p><p style="margin-left: 128px;">Gender:{{$doctor->gender}}&nbsp; &nbsp; &nbsp; Age:{{$doctor->age}}</p></td>
    <td></td>
