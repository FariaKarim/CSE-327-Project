...
<a href="{{route('formFood')}}"><button type="button" class="btn btn-danger" style="margin-left:150px;border-color: red;height: 40px;width: 200px;font-size: 20px">ADD</button></a>
<br>
<br>
