...
<div class="vertical-menu1">
    <a href="Calculation.html" class="active">ADD MEDICINE</a>
</div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-25">
      <label for="medicineName" style="font-size:20px;color:#FF4B4B">Medicine Name</label>
    </div>
    <div class="col-25">
   ...
   <div class="row">
    ...
    <div class="col-25">
      <label for="disease" style="font-size:20px;color:#FF4B4B">Disease</label>
    </div>
    <div class="col-25">
   ...
   <div class="row">
    ...
    <div class="col-25">
      <label for="sideEffect" style="font-size:20px;color:#FF4B4B">Side Effects</label>
    </div>
    <div class="col-25">
      <textarea rows="5" id="sideEffect" name="sideEffect" placeholder="Side Effects.."></textarea>
    </div>
  </div>
   <div class="row">
  
    <div class="col-25">
      <label for="group" style="font-size:20px;color:#FF4B4B">Group Name</label>
    </div>
    <div class="col-25">
      <input type="text" id="group" name="group" placeholder="Group Name..">
    </div>
  </div>
   <div class="row">
  
    <div class="col-25">
      <label for="element" style="font-size:20px;color:#FF4B4B">Elements</label>
    </div>
    <div class="col-25">
      <textarea rows="5" id="element" name="element" placeholder="Elements.."></textarea>
    </div>
  </div>
  <div class="row">
  
    <div class="col-25">
      <label for="barcode" style="font-size:20px;color:#FF4B4B">Barcode</label>
    </div>
    <div class="col-25">
